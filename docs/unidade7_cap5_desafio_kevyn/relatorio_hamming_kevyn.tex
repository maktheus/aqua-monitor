...
\fancyfoot[L]{\small\textcolor{hamminggray}{Kevyn do Nascimento Paz Gondim --- XXXXXXXX}}
\fancyfoot[C]{\small\textcolor{hamminggray}{\thepage}}
\fancyfoot[R]{\small\textcolor{hamminggray}{Prof.\ Vanderson Reis}}
...
\begin{center}
  \vspace*{1.2cm}
  {\small\textbf{UNIVERSIDADE DE BRASÍLIA -- UnB}}\\[2pt]
  {\small Departamento de Engenharia Elétrica -- ENE}\\[2pt]
...
\textbf{LVS:}                      & Correto \\
\textbf{Layout CMOS 0,35\,\textmu m:} & XOR2 + die 52×38\,\textmu m + Encoder ABBA \\
\end{tabular}
\end{resultbox}
