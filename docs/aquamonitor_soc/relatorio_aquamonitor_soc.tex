...
% Test vectors table -- split into two halves to avoid longtable memory issues
\begin{table}[H]
  \centering
  \caption{Vetores de teste V00--V14 (canais pH e Condutividade)}
  \label{tab:testvectors_a}
  \small
  \begin{tabular}{ccccccc}
    \toprule
    \textbf{Vec} & \textbf{Canal} & \textbf{Par.} &
    \textbf{VIN (mV)} & \textbf{Exp.} & \textbf{Obs.} & \textbf{Status} \\
    \midrule
...
\begin{table}[H]
  \centering
  \caption{Vetores de teste V15--V29 (canais Condutividade e Temperatura)}
  \label{tab:testvectors_b}
  \small
  \begin{tabular}{ccccccc}
    \toprule
    \textbf{Vec} & \textbf{Canal} & \textbf{Par.} &
