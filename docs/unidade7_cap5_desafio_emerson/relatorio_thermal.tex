...
% Autor  : Emerson Paes de Souza Borges
% Prof.  : Thiago Brito Bezerra
% =============================================================================
...
\usepackage[hidelinks,pdftitle={ThermalSensorChip v1.0},
            pdfauthor={Emerson Paes de Souza Borges}]{hyperref}
\usepackage{siunitx}
...
\fancyfoot[L]{\small\textcolor{thgray}{Emerson Paes de Souza Borges}}
\fancyfoot[C]{\small\textcolor{thgray}{\thepage}}
\fancyfoot[R]{\small\textcolor{thgray}{Prof.\ Thiago Brito Bezerra}}
...
% ── Logo Softex (imagem) ────────────────────────────────────────────────────
\newcommand{\logoSoftex}{\includegraphics[height=1.6cm]{softex_logo.jpg}}
...
\begin{center}
  ...
  \begin{tabular}{rl}
    \textbf{Autor:}       & Emerson Paes de Souza Borges \\
    \textbf{Professor:}   & Thiago Brito Bezerra \\
...
\begin{center}
  \vspace*{2cm}
  {\large\bfseries Emerson Paes de Souza Borges}\\[50pt]
